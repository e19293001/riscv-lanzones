...
** TODO fix bug in immediate boundary check [1/37]
   :PROPERTIES:
   :END:
   :LOGBOOK:  
   CLOCK: [2017-04-04 Tue 09:01]--[2017-04-04 Tue 09:11] =>  0:10
...
#+BEGIN_SRC asm
  Dump of assembler code for function main:
     ...
     0x00010218 <+4>:     sw      ra,12(sp)
     0x0001021c <+8>:     sw      s0,8(sp)
     0x00010220 <+12>:    addi    s0,sp,16
     0x00010224 <+16>:    jal     ra,0x101dc <fb>
     0x00010228 <+20>:    lw      a5,-1832(gp)
     0x0001022c <+24>:    mv      a1,a5
     0x00010230 <+28>:    lui     a5,0x1c
     0x00010234 <+32>:    addi    a0,a5,-384 # 0x1be80
     0x00010238 <+36>:    jal     ra,0x104cc <printf>
     0x0001023c <+40>:    lw      a5,-1964(gp)
     0x00010240 <+44>:    mv      a1,a5
     0x00010244 <+48>:    lui     a5,0x1c
     0x00010248 <+52>:    addi    a0,a5,-372 # 0x1be8c
     0x0001024c <+56>:    jal     ra,0x104cc <printf>
     0x00010250 <+60>:    li      a5,0
     0x00010254 <+64>:    mv      a0,a5
     0x00010258 <+68>:    lw      ra,12(sp)
     0x0001025c <+72>:    lw      s0,8(sp)
     0x00010260 <+76>:    addi    sp,sp,16
     0x00010264 <+80>:    ret
  End of assembler dump.
  Dump of assembler code for function fa:
     0x000101b0 <+0>:     addi    sp,sp,-16
     0x000101b4 <+4>:     sw      s0,12(sp)
     0x000101b8 <+8>:     addi    s0,sp,16
     0x000101bc <+12>:    lw      a5,-1832(gp)
     0x000101c0 <+16>:    addi    a5,a5,1
     0x000101c4 <+20>:    slli    a4,a5,0x1
     0x000101c8 <+24>:    sw      a4,-1832(gp)
     0x000101cc <+28>:    nop
     0x000101d0 <+32>:    lw      s0,12(sp)
     0x000101d4 <+36>:    addi    sp,sp,16
     0x000101d8 <+40>:    ret
  End of assembler dump.
  Dump of assembler code for function fb:
     0x000101dc <+0>:     addi    sp,sp,-16
     0x000101e0 <+4>:     sw      ra,12(sp)
     0x000101e4 <+8>:     sw      s0,8(sp)
     0x000101e8 <+12>:    addi    s0,sp,16
     0x000101ec <+16>:    li      a4,5
     0x000101f0 <+20>:    sw      a4,-1832(gp)
     0x000101f4 <+24>:    li      a4,-2
     0x000101f8 <+28>:    sw      a4,-1964(gp)
     0x000101fc <+32>:    jal     ra,0x101b0 <fa>
     0x00010200 <+36>:    nop
     0x00010204 <+40>:    lw      ra,12(sp)
     0x00010208 <+44>:    lw      s0,8(sp)
     0x0001020c <+48>:    addi    sp,sp,16
     0x00010210 <+52>:    ret
  End of assembler dump.
#+END_SRC
